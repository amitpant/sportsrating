...
@IBDesignable class RatingControl: UIStackView {
    ...
    func ratingButtonTapped(button: UIButton) {
        ...
        //if !UserDefaults.standard.bool(forKey: "isStopRatingPlayers")  {
            ...
            delegate?.playingRatingButtonTapped(ctrl:self, playerid: self.tag, rating: rating)
//        }
//        else{
//            delegate?.playingRatingButtonTapped(ctrl:self, playerid: self.tag, rating: selectedRating)
//        }
